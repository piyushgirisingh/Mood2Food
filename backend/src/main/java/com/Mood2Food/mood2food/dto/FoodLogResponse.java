...
public class FoodLogResponse {
    ...
    public FoodLogResponse(UUID id, String foodItem, String quantity, String mealType, LocalDateTime eatingTime,
                          String emotionEmoji, String emotionDescription, Integer hungerLevel, 
                          Integer satisfactionLevel, String location, String company, String notes, LocalDateTime createdAt) {
        this.id = id;
